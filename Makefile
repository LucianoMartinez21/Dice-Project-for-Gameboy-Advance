...
BUILD       	:=  build
LIBBUTANO   	:=  ../butano-20.2.0/butano
PYTHON      	:=  python3
SOURCES     	:=  src ../butano-20.2.0/common/src
INCLUDES    	:=  include ../butano-20.2.0/common/include
DATA        	:=
GRAPHICS    	:=  graphics ../butano-20.2.0/common/graphics
AUDIO       	:=  audio ../butano-20.2.0/common/audio
AUDIOBACKEND	:=  maxmod
AUDIOTOOL		:=
DMGAUDIO    	:=  dmg_audio ../butano-20.2.0/common/dmg_audio
